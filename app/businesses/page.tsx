...
export default async function page() {
    ...
    return (
        <>
                    ...
                    <div className="grid items-center gap-16 lg:grid-cols-2">
                        <div>
                            ...
                            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                                <a
                                    href="#businesses"
                                    className="inline-flex items-center justify-center rounded-2xl bg-[#c8a21a] px-7 py-4 text-sm font-semibold text-[#051933] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#d7b52f] hover:shadow-lg"
                                >
                                    Browse Businesses
                                </a>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative rounded-[32px] border border-[#eadfcb] bg-white/80 p-8 shadow-[0_20px_60px_rgba(5,25,51,0.08)] backdrop-blur-xl">
                                <div className="rounded-3xl border border-[#f0e7d9] bg-[#fcfaf6] p-7">
                                    ...
                                    <a
                                        href="#businesses"
                                        className="mt-8 flex w-full items-center justify-center rounded-2xl bg-[#051933] px-6 py-4 text-sm font-semibold text-white transition-all duration-200 hover:bg-[#0a274b]"
                                    >
            ...
            <section id="businesses" className="scroll-mt-28 bg-white py-24">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-4 text-lg leading-8 text-[#5f6b7a]">
                            Every business listed here operates under a properly structured
                            heter iska, reviewed and added by our team.
                        </p>
                    </div>
                    ...
                    {businesses.length > 0 ? (
                        ...
                        <div className="mt-16 rounded-[28px] border border-dashed border-[#eadfcb] bg-[#faf7f2] py-20 text-center">
                            <p className="text-lg font-medium text-[#051933]">
